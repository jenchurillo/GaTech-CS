...
import queue
import traceback
from solar_system import SolarSystem, MASS_SUN, AU, MASS_EARTH
    ...
    def simulate_without_sos(self, estimate_next_pos, params):
        ...
        try:
            while steps < params['max_steps']:
                ...
                if PLOT_PARTICLES is True and optional_points_to_plot is not None:
                    ...
                    # Draw the student estimate of the planet
