...
def run_kf_nonoise(field,
    ...
    true_position = \
        np.array([meteorite_initial_pos_x, meteorite_initial_pos_y])
    ...
    for t in np.arange(0, nsteps*dt, dt):
        ...
        est_position = np.array([x_tplus1_est, y_tplus1_est])
        ...
        true_position = np.array([meteorite_tplus1_x, meteorite_tplus1_y])
